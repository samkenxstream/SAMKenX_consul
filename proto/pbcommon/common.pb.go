...
func (x *QueryOptions) GetMaxQueryTime() *duration.Duration {
	if x != nil {
...
func (x *QueryOptions) GetMaxStaleDuration() *duration.Duration {
	if x != nil {
...
func (x *QueryOptions) GetMaxAge() *duration.Duration {
	if x != nil {
		return x.MaxAge
	}
	return nil
...
func (x *QueryOptions) GetStaleIfError() *duration.Duration {
	if x != nil {
...
func (x *QueryMeta) GetLastContact() *duration.Duration {
	if x != nil {
