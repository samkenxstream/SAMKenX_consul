...
func (x *CARoot) GetNotBefore() *timestamp.Timestamp {
	if x != nil {
		return x.NotBefore
	}
	return nil
...
func (x *CARoot) GetNotAfter() *timestamp.Timestamp {
	if x != nil {
		return x.NotAfter
	}
	return nil
...
func (x *CARoot) GetRotatedOutAt() *timestamp.Timestamp {
	if x != nil {
...
func (x *IssuedCert) GetValidAfter() *timestamp.Timestamp {
	if x != nil {
		return x.ValidAfter
	}
	return nil
...
func (x *IssuedCert) GetValidBefore() *timestamp.Timestamp {
	if x != nil {
