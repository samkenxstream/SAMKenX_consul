...
// RegisterHandler will register a new snapshot handler function. If a handler is
// already registered for this topic, then all open subscriptions for the topic
// will be force closed and all snapshots related to the topic will be evicted
// from the cache.
